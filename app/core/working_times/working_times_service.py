...
#     working_times = crud.working_time.get_by_job_id(db, job_id=job_id)
#     return [
...
# def get_by_ids(db: Session, ids: list):
#     working_times = [get_by_id(db, id) for id in ids]
...
#     working_time = crud.working_time.get(db, working_time_id)
#     if not working_time:
#         return custom_response_error(
#             status_code=404, status=constant.ERROR, response="Working time not found"
#         )
...
# def update_working_time_job(db: Session, job_id: int, new_working_times: list):
#     for working_time in working_times:
#         working_time = crud.working_time.remove(db, id=working_time.id)
#     working_times = []
...
#     working_time = crud.working_time.remove(db, id=working_time_id)
#     return working_time
